...
VALUES (1, 'abbr', 'unparsed_equals', '<abbr title="$1">', '</abbr>', '', '', ' ($1)', '', 0, '', '', '', '', '', '', 'optional', '', 'none'),
	...
	(33, 'php', 'unparsed_content', '', '', '<code class="php_code">$1</code>', '', '', '$1', 0, '', '$add_begin = substr(trim($data), 0, 5) != ''&lt;'';\r\n$data = highlight_php_code($add_begin ? ''&lt;?php '' . $data . ''?&gt;'' : $data);\r\nif ($add_begin)\r\n	$data = preg_replace(array(''~^(.+?)&lt;\\?.{0,40}?php(?:&nbsp;|\\s)~'', ''~\\?&gt;((?:</(font|span)>)*)$~''), ''$1'', $data, 2);', '', '', '', '', 'none', '', 'none'),
	(34, 'pre', 'parsed', '<pre>', '</pre>', '', '', '', '', 0, '', '', '', '', '', '', 'none', '', 'none'),
	(35, 'quote', 'parsed', '<div class="quoteheader">{{quote}}</div><blockquote>', '</blockquote><div class="quotefooter"></div>', '', '', '', '', 1, '', '', '', '', '', '', 'none', '', 'none'),
	(36, 'quote', 'parsed', '<div class="quoteheader">{{quote_from}} {author}</div><blockquote>', '</blockquote><div class="quotefooter"></div>', '', '', '', '', 1, '', '', '', '', '', '', 'none', 'a:1:{s:6:"author";a:2:{s:5:"match";s:11:"(.{1,192}?)";s:6:"quoted";b:1;}}', 'none'),
	(37, 'quote', 'parsed_equals', '<div class="quoteheader">{{quote_from}} $1</div><blockquote>', '</blockquote><div class="quotefooter"></div>', '', '', '', '', 1, '', '', '', '', '', 'url,iurl,ftp', 'optional', '', 'none'),
	(38, 'quote', 'parsed', '<div class="quoteheader"><a href="{{scripturl}}?{link}">{{quote_from}} {author} {{search_on}} {date}</a></div><blockquote>', '</blockquote><div class="quotefooter"></div>', '', '', '', '', 1, '', '', '', '', '', '', 'none', 'a:3:{s:6:"author";a:1:{s:5:"match";s:15:"([^<>]{1,192}?)";}s:4:"link";a:1:{s:5:"match";s:83:"(topic=[\\dmsg#\\./]{1,40}(?:;start=[\\dmsg#\\./]{1,40})?|action=profile;u=\\d+|msg=\\d+)";}s:4:"date";a:2:{s:5:"match";s:5:"(\\d+)";s:8:"validate";s:13:"on_timeformat";}}', 'none'),
	(39, 'quote', 'parsed', '<div class="quoteheader">{{quote_from}} {author}</div><blockquote>', '</blockquote><div class="quotefooter"></div>', '', '', '', '', 1, '', '', '', '', '', '', 'none', 'a:1:{s:6:"author";a:1:{s:5:"match";s:11:"(.{1,192}?)";}}', 'none'),
	(40, 'right', 'parsed', '<div style="text-align: right">', '</div>', '', '', '', '', 1, '', '', '', '', '', '', 'none', '', 'none'),
	...
	(45, 'spoiler', 'parsed', '<div class="spoiler"><div class="spoilerhint"><input type="button" value="{{spoiler}}" onclick="n = this.parentNode.parentNode.lastChild.style; n.display = n.display == ''none'' ? ''block'' : ''none''; return false;">{{click_for_spoiler}}</div><div class="spoiled" style="display: none">', '</div></div>', '', '', '', '', 1, '', '', '', '', '', '', 'none', '', 'none'),
	...
	(54, 'url', 'unparsed_content', '', '', '<a href="$1" class="bbc_link" target="_blank">$1</a>', '', '', '', 0, '', '$data = strtr($data, array(''<br>'' => ''''));\r\nif (strpos($data, ''http://'') !== 0 && strpos($data, ''https://'') !== 0)\r\n	$data = ''http://'' . $data;', '', '', '', '', 'none', '', 'none'),
...
VALUES ('smfVersion', '{$wedge_version}'),
	...
	('warning_moderate', '35'),
	('warning_mute', '60'),
	('admin_features', 'm,e,cd,cp,k,w,rg,ml,pm'),
