...
VALUES
	...
	(37, 'quote', 5, 'parsed_equals', '<div class="bbc_quote"><header>{{quote_from}} $1</header><div><blockquote>', '</blockquote></div></div>', '', '', '', '', 1, '', '', '', '', '', 'url,iurl,ftp', 'optional', '', 'outside', ''),
	...
	(39, 'quote', 5, 'parsed', '<div class="bbc_quote"><header>{{quote_from}} {author}</header><div><blockquote>', '</blockquote></div></div>', '', '', '', '', 1, '', '', '', '', '', '', 'none', 'a:1:{s:6:"author";a:1:{s:5:"match";s:11:"(.{1,192}?)";}}', 'outside', ''),
