...
VALUES (1, 'abbr', 'unparsed_equals', '<abbr title="$1">', '</abbr>', '', '', ' ($1)', '', 0, '', '', '', '', '', '', 'optional', '', 'none', ''),
	...
	(6, 'center', 'parsed', '<div class="center">', '</div>', '', '', '', '', 1, '', '', '', '', '', '', 'none', '', 'none', ''),
	...
	(23, 'left', 'parsed', '<div class="left">', '</div>', '', '', '', '', 1, '', '', '', '', '', '', 'none', '', 'none', ''),
